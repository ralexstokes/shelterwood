...
without consulting the current codebase, its issue tracker, or its
documentation.
...
**Structure.** The spec is staged in three parts, in build order, one
document per part in this folder:

- **Part I — Core** (§1–§14, this document): the v0 conformance target.
  Complete on its own: a library implementing only Part I is useful and
  correct.
- **Part II — Core plus** (§15–§23, [core-plus.md](core-plus.md)): features
  specified now, built later. Each is individually adoptable; each section
  states the hook Part I must already carry so the feature lands without
  redesign.
- **Part III — Non-core** (§24, [non-core.md](non-core.md)): never in the
  core crate.
...
- [Part II — Core plus](core-plus.md) (§15–§23, own document)
- [Part III — Non-core](non-core.md) (§24, own document)
...
marked *(II)* ship with the named [Part II](core-plus.md) feature.
