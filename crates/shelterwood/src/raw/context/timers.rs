...
use super::super::disposal::{Contained, RawDisposal};
...
pub(super) struct ArmingOrder(pub(super) u64);
...
pub(super) struct TimerEntry<M> {
    pub(super) key: Box<dyn Any + Send>,
    ...
    pub(super) message: TimerMessage<M>,
...
impl<M> TimerStore<M> {
    ...
    pub(super) fn remove_arming(&mut self, arming_order: ArmingOrder) -> Option<TimerEntry<M>> {
